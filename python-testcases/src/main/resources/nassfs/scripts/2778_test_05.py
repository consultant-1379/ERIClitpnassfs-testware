...
class Test05(NaslibTest):
    ...
    def test_05(self):
        ...
        with self.connect_to_nfs() as s:
            ...
            self.assertRaises(Snapshot.DoesNotExist, s.snapshot.restore,
                              "fake_snap", new_fs_name)

if __name__ == "__main__":
    suite = unittest.TestLoader().loadTestsFromTestCase(Test05)
